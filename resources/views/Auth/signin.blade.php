        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    ...
                    <div class="mx-auto">
                        <h3>Sign In to Esk Inventory 🥳</h3>
                        <p>
                            Log in to your account  <br />
                             in search of Exclusive Products
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-4">
                        <a href="/" class="app-brand-link gap-2 mb-2">
                            ...
                            <span class="app-brand-text demo h3 mb-0 fw-bold">Esk Inventory</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to Esk Inventory! 👋</h4>
                    <p class="mb-4">Please sign-in to your account and start your shopping spree</p>
